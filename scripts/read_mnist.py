...
class MNIST(object):
    def __init__(self, path='.'):
        ...
        self.test_img_fname = 'mnist/t10k-images-idx3-ubyte'
        self.test_lbl_fname = 'mnist/t10k-labels-idx1-ubyte'

        self.train_img_fname = 'mnist/train-images-idx3-ubyte'
        self.train_lbl_fname = 'mnist/train-labels-idx1-ubyte'
