...
original author (the code was a physics game with dots in a box):
...
init_state[:, 0] = 0.0
init_state[:, :2]  = -0.5 + np.random.random((50, 2)) #appear along a line at the center (randomly y-axis)
...
particles, = ax.plot([], [], 'wo', ms=0.2, markersize=1)
matplotlib.markers.MarkerStyle(marker='D')
...
def animate(i):
    ...
    box.random_dots(dt,index_direction_l,index_direction_r)
