...
# Perceptrons Network class with features extraction mn256r1 
# ===============================
...
class Perceptrons:
    def __init__(self, perceptrons_pop, features_pop,  cee=1.0, n_class = 2):
        ...
        self.matrix_programmable_rec  = np.random.choice([0,1], size=(256,256))
        self.matrix_programmable_rec[128:256,0:256]  = 0
        self.matrix_programmable_rec[0:128,127:256]  = 0
        self.matrix_programmable_w  = np.random.choice([0,1,2,3], size=(256,256))
