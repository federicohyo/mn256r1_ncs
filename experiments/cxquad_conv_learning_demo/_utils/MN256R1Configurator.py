...
class MN256R1Configurator():
    ...
    #default file
    defaultfile = bias_folder+'defaultBiases.txt'
    ...
    def get_bias_value(self,thisbiasName,default_biases):
        print 'Reading bias value...'
        for i in range(len(self.biasNames)):
            if(default_biases[i][0] == thisbiasName):
                break
        return default_biases[i]
    ...
    def set_all_biases(self,biases_dict):
        for i in range(len(biases_dict)):
            self.set_bias(biases_dict[i][0],biases_dict[i][1],int(biases_dict[i][2]),
			              biasLowHigh = biases_dict[i][3],
			              biasCascode = biases_dict[i][4],
			              biasType = biases_dict[i][5],
			              biasEnable = biases_dict[i][6])
