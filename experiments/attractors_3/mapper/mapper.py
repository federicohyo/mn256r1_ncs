...
def init_mappings(offsetchip0,offset_usb,offsetadcs):
    ...
    for i in range(8):
        ...
        mapper_wrap.programBulkSpec(i,0)
    ...
    #mapper_wrap.programBulkSpec(2,2**1) #adcs to usb
    ...
    #mapper_wrap.programMemory(offset_usb+0,-(2**29),0)

    #mapper_wrap.programOffset(2,offsetadcs)
    #mapper_wrap.programMemory(offsetadcs+1,offsetadcs+500,1)
    #mapper_wrap.programMemory(offsetadcs+500,500,1)

    #usb to 0 and 3 address range
    mapper_wrap.programAddressRange(0,(2**32)-1)
    mapper_wrap.programAddressRange(1,(2**32)-1)
    #mapper_wrap.programAddressRange(2,0)
