...
def load_connections_matrix_programmable(matrix):
    '''
...
def load_connections_matrix_all(matrix):
    '''
...
def load_weight_matrix_plastic(matrix):
    '''
...
def load_matrix_exc_inh(matrix):
    '''
...
def load_weight_matrix_programmable(matrix):
    '''
